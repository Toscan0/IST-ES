...
public class RentACarGetAllAvailableVehiclesTest {
	...
	public void onlyCars() {
		Vehicle car1 = new Car(PLATE_CAR1, 10, PRICE_OF_CAR, rentACar1);
		car1.rent(DRIVING_LICENSE, date1, date2, buyerNif,  buyerIban);
		Vehicle car2 = new Car(PLATE_CAR2, 10,  PRICE_OF_CAR,rentACar2);
		Vehicle motorcycle = new Motorcycle(PLATE_MOTORCYCLE, 10, PRICE_OF_MOTOCYCLE, rentACar1);
	...
	public void onlyMotorcycles() {
		Vehicle car = new Car(PLATE_CAR1, 10, PRICE_OF_CAR, rentACar1);
		Vehicle motorcycle = new Motorcycle(PLATE_MOTORCYCLE, 10, PRICE_OF_MOTOCYCLE, rentACar1);
